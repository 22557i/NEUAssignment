...
public class DriverMainJPanel extends javax.swing.JPanel {
    ...
    public DriverMainJPanel(EcoSystem system, JPanel container, Network net, UserAccount userAccount, JFrame frame) {
        initComponents();
        this.system = system;
        this.container = container;
        this.network = net;
        this.driverAccount = (DriverAccount) userAccount;
        this.frame = frame; 
        this.workQueue = new WorkQueue();
        this.driver = this.driverAccount.getDriver();
        lblDriverName.setText(driverAccount.getUsername());
       
        populateTableDriveRequest();
        setInfo();
    ...
    private void initComponents() {
        ...
        lblDriverName.setForeground(new java.awt.Color(161, 23, 21));
        ...
        tableDriveRequest.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        lblCustomerPhone.setForeground(new java.awt.Color(161, 23, 21));
        ...
        btnAccept.setForeground(new java.awt.Color(161, 23, 21));
        ...
        btnAtWork.setBackground(new java.awt.Color(255, 255, 255));
        btnAtWork.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnAtWork.setForeground(new java.awt.Color(161, 23, 21));
        ...
        btnFinished.setForeground(new java.awt.Color(161, 23, 21));
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(txtRemark, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 261, Short.MAX_VALUE))
                .addGap(105, 105, 105)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
     ...
     private void populateTableDriveRequest() {
        DefaultTableModel dtm = (DefaultTableModel) tableDriveRequest.getModel();
        dtm.setRowCount(0);
        for (WorkRequest wr : this.driverAccount.getDriveRequestDirectory()) {
            DriveRequest dr = (DriveRequest)wr;
            Object row[] = new Object[8];
            //order id
            row[0] = dr.getOrderRequest();
            //order date
            ...
            //expected pay
            row[7] = (dr.getOrderRequest().getTotalPrice())*0.7;
            dtm.addRow(row);
        }
    }
    ...
    private void setInfo() {
        txtUsername.setText(driverAccount.getUsername());
        txtName.setText(driver.getFirstName()+" "+driver.getLastName());
    ...
    private void btnSaveProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveProfileActionPerformed
       ...
       if (!txtName.getText().equals("") && !txtAddress.getText().equals("")
                && !txtPhone.getText().equals("") && !txtEmail.getText().equals("") && !txtUsername.getText().equals("")) {
            String s[] = txtName.getText().split(" ");
            this.driver.setLastName(s[0]);
            this.driver.setFirstName(s[1]);
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        int row = tableDriveRequest.getSelectedRow();
        if(row>-1){
        selectedRequest =(OrderRequest) tableDriveRequest.getValueAt(row, 0);
    
        selectedRequest.setStatus(WorkRequest.StatusEnum.Accepted);
       // selectedRequest.setDriverAccount(this.driverAccount);
        selectedRequest.setStatus(WorkRequest.StatusEnum.Accepted);
        txtCustomerName.setText(selectedRequest.getCustomerName());
        txtCustomerPhone.setText(selectedRequest.getCustomerPhone());
        txtRemark.setText(selectedRequest.getRemark());
        
      
        
        populateTableDriveRequest();
        //populateDetails();
        }else JOptionPane.showMessageDialog(null, "GGWP");
    ...
    private void btnAtWorkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtWorkActionPerformed
        ...
        if(row>-1){
        selectedRequest =(OrderRequest) tableDriveRequest.getValueAt(row, 0);
        if(selectedRequest.getStatus().equals(WorkRequest.StatusEnum.Accepted)){
        selectedRequest.setStatus(WorkRequest.StatusEnum.AtWork);
       // selectedRequest.setDriverAccount(this.driverAccount);
        selectedRequest.setStatus(WorkRequest.StatusEnum.AtWork);
        populateTableDriveRequest();
        }else JOptionPane.showMessageDialog(null, "Please choosec Accepted Order!");
        }else JOptionPane.showMessageDialog(null, "GGWP");
    ...
    private void btnFinishedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinishedActionPerformed
        ...
        if(row>-1){
        selectedRequest =(OrderRequest) tableDriveRequest.getValueAt(row, 0);
        if(selectedRequest.getStatus().equals(WorkRequest.StatusEnum.AtWork)){
        selectedRequest.setStatus(WorkRequest.StatusEnum.Finished);
        //selectedRequest.setDriverAccount(this.driverAccount);
        selectedRequest.setStatus(WorkRequest.StatusEnum.Finished);
            LinkedList<OrderRequest> templist = new LinkedList<>();
            templist.add(selectedRequest);
        if(selectedRequest.getAccount() instanceof CustomerAccount){
            ((CustomerAccount)selectedRequest.getAccount()).setFinishedOrder(templist);
            
        }
        DB4OUtil.getInstance().storeSystem(system);
        populateTableDriveRequest();
        }else JOptionPane.showMessageDialog(null, "Please choosec Atwork Order!");
        }else JOptionPane.showMessageDialog(null, "GGWP");
    ...
    private void populateDetails(){
        OrderRequest or = (OrderRequest) selectedRequest;
