...
public class CustomerAccountInfoJPanel extends javax.swing.JPanel {
     ...
     */
    public CustomerAccountInfoJPanel(EcoSystem system, JPanel container, CustomerAccount account, JFrame frame,String accessRole) {
        initComponents();
        this.system = system;
        ...
        this.account.setOrderDirectory(new ArrayList<>()); 
        //Boston PickupService Company List
        this.account.getOrderDirectory().add(new OrderRequest(new PickupService("Boston PickUp Agency", "2 Pleasant Street, Boston, MA 02125", "(617) 123-3232"), this.account, "NEU", "Chinatown", 2.7, 13.2, "Economy for 4"));
        setInfo();
    ...
    private void setInfo() {
        ...
        txtName.setText(this.account.getCustomer().getName());
        txtPhone.setText(this.account.getCustomer().getPhone());
        txtAddress.setText(this.account.getCustomer().getAddress());
        txtEmail.setText(this.account.getCustomer().getEmail());
    }
    
    private void populateTableOrderHistory() {
        DefaultTableModel dtm = (DefaultTableModel)tableOrderHistory.getModel();
        dtm.setRowCount(0);
        if(this.account instanceof CustomerAccount)
        for(OrderRequest or: ((CustomerAccount)this.account).getFinishedOrder()){
            Object row[] = new Object[8];
            
            row[0] = or;
            row[1] = or.getDateString();
            row[2] = or.getStatus();
            row[3] = "Cargo Boston Delivery";
            row[4] = "Driver1";
            row[5] = or.getTotalPrice();
            row[6] = or.getReviewStatus();
            row[7] = or.getReview().getRate();
            dtm.addRow(row);
    ...
    private void initComponents() {
        ...
        lblName.setForeground(new java.awt.Color(161, 23, 21));
        ...
        lblEmail.setForeground(new java.awt.Color(161, 23, 21));
        lblEmail.setText("Email");

        btnSaveProfile.setBackground(new java.awt.Color(255, 255, 255));
        btnSaveProfile.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnSaveProfile.setForeground(new java.awt.Color(161, 23, 21));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(txtUsername, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE)
                    .addComponent(txtName)
                    .addComponent(txtAddress)
                    .addComponent(txtPhone)
                    .addComponent(txtEmail, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 365, Short.MAX_VALUE))
                .addGap(196, 196, 196))
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(329, 329, 329)
                .addComponent(btnSaveProfile, javax.swing.GroupLayout.PREFERRED_SIZE, 175, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnCurrent.setForeground(new java.awt.Color(161, 23, 21));
        btnCurrent.setText("Current Password");

        btnNew.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnNew.setForeground(new java.awt.Color(161, 23, 21));
        btnNew.setText("New Password");

        btnConfirm.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnConfirm.setForeground(new java.awt.Color(161, 23, 21));
        btnConfirm.setText("Confirm Password");

        btnSavePassword.setBackground(new java.awt.Color(255, 255, 255));
        btnSavePassword.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnSavePassword.setForeground(new java.awt.Color(161, 23, 21));
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pfCurrent, javax.swing.GroupLayout.DEFAULT_SIZE, 165, Short.MAX_VALUE)
                    .addComponent(pfNew)
        ...
        tableOrderHistory.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        tableOrderHistory.setForeground(new java.awt.Color(161, 23, 21));
        tableOrderHistory.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order ID", "Order Date", "Order Status", "Company", "Driver", "Pay", "status", "Score"
            }
        ) {
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(txtRate, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(143, 143, 143)
    ...
    private void btnSaveProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveProfileActionPerformed
       ...
       String s[] = txtName.getText().split(" ");
        this.account.getCustomer().setFirstName(s[0]);
        this.account.getCustomer().setLastName(s[1]);
        this.account.getCustomer().setPhone(txtPhone.getText());
        this.account.getCustomer().setAddress(txtAddress.getText());
        this.account.getCustomer().setEmail(txtEmail.getText());
    ...
    private void btnSavePasswordActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSavePasswordActionPerformed
        // TODO add your handling code here:
      char[] passwordCharArray = pfCurrent.getPassword();
        String password = String.valueOf(passwordCharArray);
        char[] passwordCharArray1 = pfNew.getPassword();
        String new1 = String.valueOf(passwordCharArray1);
        char[] passwordCharArray2 = pfConfirm.getPassword();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int index = tableOrderHistory.getSelectedRow();
        ((OrderRequest)tableOrderHistory.getValueAt(index, 0)).getReview().setRate(Double.valueOf(txtRate.getText()));
       populateTableOrderHistory();
       
        LinkedList<OrderRequest> templist = new LinkedList<>();
        
       if(((OrderRequest)tableOrderHistory.getValueAt(index, 0)).getEnterprise() instanceof CargoDelivery)((CargoDelivery) ((OrderRequest)tableOrderHistory.getValueAt(index, 0)).getEnterprise()).setFinishedOrder(templist);
       if(((OrderRequest)tableOrderHistory.getValueAt(index, 0)).getEnterprise() instanceof PickupService)((PickupService) ((OrderRequest)tableOrderHistory.getValueAt(index, 0)).getEnterprise()).setFinishedOrder(templist);
