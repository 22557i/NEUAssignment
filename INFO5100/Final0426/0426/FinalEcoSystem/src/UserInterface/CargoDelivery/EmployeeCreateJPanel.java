 ...
 * @author junxiang
 */
public class EmployeeCreateJPanel extends javax.swing.JPanel {
     ...
     */
    public EmployeeCreateJPanel(EcoSystem system, JPanel panel, JPanel workPanel, CargoDelivery cargoDelivery) {
        initComponents();
        this.system = system;
        this.panel = panel;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         Employee em = cargoDelivery.getEmployeeDir().createEmployee(firstnameTextField.getText(), lastnameTextField.getText(), phoneTextField.getText(), emailTextField.getText());
        cargoDelivery.getUserAccounts().createEmployeeAccount(nameTextField.getText(), PasswordField1.toString(), em);
