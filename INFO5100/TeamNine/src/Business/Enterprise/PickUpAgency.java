 ...
 * @author ranranhe
 */
public class PickUpAgency extends Enterprise {
    ...
    public PickUpAgency(String name,String address, String phone) {
        super(name);
    ...
    public void createOrganizations() {
        ...
        this.getOrganizationDirectory().getOrganizationList().add(new PickUpOrganization());
    }
