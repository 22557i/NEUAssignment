...
//create CargoDelivery Manager Account
   public CargoManagerAccount createCargoManagerAccount(String username, String password, Employee cargoManager, CargoDelivery enterprise) {
        CargoManagerAccount da = new CargoManagerAccount(username, password, cargoManager,enterprise);
        userAccountList.add(da);
        return da;
    }
