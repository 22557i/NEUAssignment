...
public class CreateProductJPanel extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        // TODO add your handling code here:
            if(txtProdName.getText().equals("")||txtAvailablity.getText().equals("")||txtPrice.getText().equals("")||txtDescription.getText().equals("")){
                JOptionPane.showMessageDialog(null, "ONe or more fields are empty");
                return;
            }
            int avaliability = 0;
            try{
             avaliability = Integer.parseInt(txtAvailablity.getText());
