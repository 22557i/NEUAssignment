...
public class CargoAgencyWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public CargoAgencyWorkAreaJPanel(EcoSystem system, JPanel container, Network net, Enterprise en,
       ...
       // this.accessRole = accessRole;
        ...
        populateEmployeeTable(cargoDelivery.getOrganizationDirectory().getOrganizationList());

        if (accessRole.getRoleType().equals(Role.RoleType.Manager)) {
        ...
        // Review Panel
        populateReviewTable();
        if (cargoDelivery.getRate() == -1) {
            currentRateTextField.setText("N/A");
        } else {
            currentRateTextField.setText(cargoDelivery.getRate() + "");
        }
    }
...
//        nameLabel.setText(cargoDelivery.getName());
        nameTextField.setText(cargoDelivery.getName());
        TelTextField3.setText(cargoDelivery.getPhone());
        AddressTextField4.setText(cargoDelivery.getAddress());
        BriefIntroTextField1.setText(cargoDelivery.getDescription());
    ...
    public void populateserviceTable() {
        ...
        dtm.setRowCount(0);
        for (Service service : cargoDelivery.getMenu()) {
    ...
    public void populateOrderTable() {
        ...
        dtm.setRowCount(0);
        for (WorkRequest wr : cargoDelivery.getWorkQueue().getWorkRequestList()) {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Work Area -- Cargo Delivery Company Manager Role ");
        ...
        createServiceButton1.setText("Create Service");
        ...
        removeServicejButton.setText("Remove Service");
                    ...
                    .addGroup(reviewPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(reviewPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(reviewPanelLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(currentRateTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if (!TelTextField3.getText().equals("") && !AddressTextField4.getText().equals("")
            ...
            cargoDelivery.setName(nameTextField.getText());
            cargoDelivery.setAddress(AddressTextField4.getText());
            cargoDelivery.setDescription(BriefIntroTextField1.getText());
            cargoDelivery.setPhone(TelTextField3.getText());
    ...
    private void createServiceButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createServiceButton1ActionPerformed
        ServiceCreateJPanel p = new ServiceCreateJPanel(system, this, createPanel, this.cargoDelivery);
    ...
    private void removeServicejButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeServicejButtonActionPerformed
        ...
        if (index >= 0) {
            CargoDelivery res = (CargoDelivery) this.en;
            int choice = JOptionPane.showConfirmDialog(null, "Are you sure to remove this service from the system?");
            if (choice == 0) {
    ...
    private void DetailsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DetailsButtonActionPerformed
        ...
        if(selectedRow>=0){
//            Patient patient = (Patient)reviewTable.getValueAt(selectedRow, 0);
//            ViewPatient viewPatient = new ViewPatient(userProcessContainer,patient, patientList);
//            userProcessContainer.add("ViewPatient",viewPatient);
